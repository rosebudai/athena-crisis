...
Project-level testing context. Consumed by the outer loop's ① VALIDATE step alongside the feature-specific QA Plan in `.claude/specs/<feature>/spec.md`.
...
QA PLAN STEPS:
[paste QA Plan steps from spec.md here, mapping each to stepN.png]" \
  -m gemini-3.1-pro-preview \
